            ...
            <Table hover striped bordered variant='success'>
                <thead>
                    <tr className='text-center'>
                        ...
                        <th>출판사</th>
                        <th>저장</th>
                        <th><input className='me-3' type='checkbox' checked={books.length === chcnt} onChange={onChangeAll} /><Button variant='success' size='sm' onClick={onClickSave}>선택저장</Button></th>
                    </tr>
                </thead>
                <tbody className='text-center'>
                    {books.map(book =>
                        <tr key={book.isbn}>
                            ...
                            <td><Button onClick={() => onInsert(book)} variant='success'>저장</Button></td>
